                        ...
                        <tbody>
                            <tr>
                                <td
                                    ...
                                    align="left"
                                >
                                    Stranica {{ items.current_page }}/{{
                                        items.last_page
                                    }}
                                    : Podataka {{ items.total }}
                                </td>
                        ...
                        <tbody>
                            <tr v-for="items in items.data" :key="items.id">
                                ...
                                <td>
                                    <button
                                        class="button_primary"
                                        @click="view_warranty(items.id)"
                                    >
                                        Pregled
                                    </button>
                                    <button
                                        class="button_primary"
                                        @click="print_warranty(items.id)"
                                    >
                                        Print
                                    </button>
                                </td>
...
export default {
    ...
    data: function() {
        return {
            ...
            comment_approved: this.$props.prop_data.prop_values
                .comment_approved,

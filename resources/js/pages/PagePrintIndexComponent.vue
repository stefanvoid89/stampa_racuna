                        ...
                        <tbody>
                            <tr>
                                <td
                                    ...
                                    align="left"
                                >
                                    Stranica {{ invoices.current_page }}/{{
                                        invoices.last_page
                                    }}
                                    : Podataka {{ invoices.total }}
                                </td>
...
export default {
    ...
    data: function() {
        return {
            ...
            Recepcionista:
                this.$props.prop_data.prop_values.Recepcionista || "",
            ...
            FechaFacturaFrom:
                this.$props.prop_data.prop_values.invoce_date || "",
    ...
    methods: {
        ...
        set_subject: function(sub) {
            var subject = this.Clientes.find(
                subject => subject.acSubject == sub
            );

            this.$data.Cliente = subject
                ? subject
                : { anId: null, acSubject: sub };
        },

        build_query_string: function() {
            var query_string_object = {};

            if (this.Cliente.anId)
                query_string_object["Cliente"] = this.Cliente.anId;
            ...
            if (this.numot.length > 0)
                query_string_object["numot"] = this.numot;

            if (this.AnoOT.length > 0)
                query_string_object["AnoOT"] = this.AnoOT;
            ...
            if (this.Matric.length > 0)
                query_string_object["Matric"] = this.Matric;
        ...
        refresh_page_with_filter: function() {
            ...
            if (query_string.length)
                window.location.href = `print/?${query_string}`;
